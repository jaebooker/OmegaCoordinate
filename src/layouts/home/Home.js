      ...
      <main className="container">
        <div className="pure-g">
          <div className="pure-u-1-1">
            ...
            <p>Check out our Medium articles "How to Hunt A Mammoth" <a href="https://medium.com/@jaesonbooker/how-to-hunt-a-mammoth-50579302f3a3" target="_blank"> and "After the Hunt" <a href="https://medium.com/@jaesonbooker/after-the-hunt-how-to-hunt-a-mammoth-part-ii-db969f8cfdb" target="_blank"></p>
          </div>
        </div>
      </main>
    )
